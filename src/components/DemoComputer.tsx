...
import { Group, Mesh, VideoTexture, Material } from 'three';
...
export const DemoComputer: React.FC<DemoComputerProps> = (props) => {
  ...
  const textureUrl = props.texture || '/textures/project/movelo.mp4';

  const txt: VideoTexture | undefined = useVideoTexture(textureUrl);
